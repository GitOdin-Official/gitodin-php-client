...
if(!trait_exists("Instance") && version_compare(PHP_VERSION, '5.0.0', '>=')){
...
// Here is an Example if you had a User Control Class.
/*

<?php

  UserSession::getInstance()->setUserId(885544);
  echo UserSession::getInstance()->getUserId();
